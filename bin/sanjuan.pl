...
my @SANJUAN_files=("annotate_Diff_Used_Introns.pl","annotate_Diff_Used_Junctions.pl","calc_INTRON_retention.pl","calc_JUNCT_efficiency.pl","get_juncts.pl","ln_s_wrapper.sh","merge_junctions.pl","preProcess_and_Map.pl","SANJUAN_wrapper.pl","sort_wrapper.sh","Mapped_junctions2IntronSegments.pl","bedtools_intersect_NJ.sh","bedtools_intersect_ST.sh","bedtools_intersect.sh");
